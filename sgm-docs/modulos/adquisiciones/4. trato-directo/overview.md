...
**Integración con Mercado Público:** 0 deep links (fase inicial completamente interna al SGM) + 1 lectura API con **doble validación**: el SGM verifica vía lectura que el proceso figure válidamente **"Publicado"** en MP **y** que la OC asociada esté **"Aceptada"**. Ver [`integracion-mercado-publico.md`](../../../arquitectura/especificacion/integracion-mercado-publico.md). Sin ambas confirmaciones, el SGM **bloquea el paso contable a Compromiso Cierto** — garantía de diseño de que ninguna contratación directa oculta llega a pago. **Hito contable crítico:** doble validación (Publicado + OC Aceptada) → Compromiso Cierto.
