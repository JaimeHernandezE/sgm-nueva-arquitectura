...
- **Publicidad en 24 horas:** la resolución y la OC deben publicarse en el portal en máximo 24 horas desde su total tramitación (firma) — publicación + vinculación en §3.2 (**[PENDIENTE X-71]** control bloqueante vs. trazabilidad).
...
**Edge cases normativos que el proceso debe cubrir:** reparo de Contraloría (→ proceso se cae, obligación de licitar); rechazo de OC por el proveedor (→ Trato Directo queda sin efecto; nuevo proceso con nueva justificación — **[PENDIENTE X-69]**); fiscalización posterior adversa (el sistema debe conservar la trazabilidad completa de la causal, cotizaciones previas y resolución para defensa en auditoría).
