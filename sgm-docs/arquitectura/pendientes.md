...
| P-16 | Especificación del ambiente sandbox (alcance, datos sintéticos, disponibilidad pública). Marco: [`entregable-licitacion.md`](./entregable-licitacion.md) §5; detalle operativo: [`sandbox-desarrolladores.md`](./sandbox-desarrolladores.md) | decisiones-macro-stack §10, entregable-licitacion §5 | ninguna | Abierto |
...
| P-37 | Carga inicial de valores de `NormativeParameter` (tramos de licitación, umbrales de garantías) verificados contra norma vigente post Ley 21.634 | procesos-transversales/2-modalidad-compra.md §2.1 | jurídica | Abierto |
...
| P-48 | Redactar `plataforma/contracts.md` — contrato del core (identidad, roles, tenants, parámetros, auditoría, eventos) con las cuatro secciones de contrato-api-first §3 | plataforma-core §2, entregable-licitacion §9.1, §10 | ninguna | **Borrador mínimo** |
