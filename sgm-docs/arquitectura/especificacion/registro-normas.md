...
| N-09 | Ley 19.886 | Ley | No verificada | Adq overview / modalidades / SOLPED / pago / wireframes; `pendientes.md` (X-36, X-37); `musts-arquitectura.md`; `plantilla-maestra-sgm.md`; `principios-no-negociables.md`; `decisiones-macro-stack.md`; y otros | Compras públicas; causales TD (X-36); primera opción CM |
...
| N-15 | Ley 21.180 | Ley | No verificada | `estandar-firma-electronica.md`; `seguridad.md`; `nodo-integracion-subdere.md` | Transformación digital del Estado |
