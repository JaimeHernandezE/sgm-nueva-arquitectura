...
4. **Actos administrativos ≠ cableado directo a FirmaGob.** Decretos y resoluciones se tramitan vía **DocDigital (C11)** — decisión [`2026-07-docdigital-tramitacion-documental.md`](../decisiones/2026-07-docdigital-tramitacion-documental.md); FirmaGob queda incluido en esa plataforma. C9 (`requestSignature`) aplica a documentos que **no** son esos actos (CDP, vistos buenos, actas, contratos según inventario). Contrato funcional: [`integracion-docdigital.md`](./integracion-docdigital.md).
