...
export const stages = [
    ...
    steps: [
      {
        ...
        secondaryLine: 'Tiempo transcurrido: 0 d 4 h · Modalidad indicada: Convenio Marco · Ítem catálogo: Silla ergonómica CM-8842 (400 unidades) · Monto: $ 80.000.000',
      },
      {
        id: '1.2',
      ...
      },
      {
        ...
        secondaryLine: 'Tiempo transcurrido: 0 d 2 h · Monto preobligado: $ 80.000.000',
  ...
  },
  {
    ...
    status: 'Finalizada',
    summary: 'Convenio Marco confirmado · Gran Compra (> 1.000 UTM) · vinculación MP diferida a etapa 3',
    expanded: true,
    state: 'done',
    ...
    steps: [
      ...
      },
      {
        ...
        status: 'omitted',
        action: { type: 'badge', label: 'Omitido (optativo)' },
        secondaryLine: 'Diferido al sub-paso 3.2 (Compra Directa) o 3.3 (Gran Compra) de Convenio Marco, según ruta de umbral',
        omitted: true,
