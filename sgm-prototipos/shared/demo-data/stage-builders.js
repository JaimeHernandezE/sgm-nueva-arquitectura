  ...
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        status: 'No iniciado',
        responsible: { unit: 'DAF Abastecimiento', role: 'Gestor de compra', name: 'Rodrigo Muñoz' },
        secondaryLine: 'Camino alternativo · No ocurrió — OC aceptada en 3.3. Solo si el proveedor rechaza (X-69)',
        pendingCondition: 'Condicional — excluyente con 3.3, se muestra para explorar la decisión post-rechazo.',
        action: { type: 'secondary', label: 'Ver camino alternativo' },
        origin: { kind: 'external', label: 'Mercado Público', mode: 'solo lectura' },
        state: 'pending',
      },
