...
export const contabilidadNav = [
  ...
  { id: 'preob', label: 'Preobligaciones', path: 'modulos/contabilidad/index.html#preob' },
  { id: 'oc', label: 'Devengado desde Adquisiciones', path: 'modulos/contabilidad/index.html#oc' },
  ...
  { id: 'caja', label: 'Caja y rendiciones', path: 'modulos/contabilidad/index.html#caja' },
  ...
  { id: 'inv', label: 'Inventario y bajas', path: 'modulos/contabilidad/index.html#inv' },
  { id: 'cierres', label: 'Cierres contables', path: 'modulos/contabilidad/index.html#cierres' },
  { id: 'cfg', label: 'Configuración', path: 'modulos/contabilidad/index.html#cfg' },
